    ...
    return (
        <div className="text-center">
            ...
            <div className="px-4 pt-3  bg-black bg-opacity-10">
                <h1 className="display-4 fw-bold text-light">Airline Reservation System</h1>
                <div className="col-lg-6 mx-auto">
                    ...
                    <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                        <a href="/book" className="btn btn-outline-light btn-lg px-4 me-sm-3">Login</a>
                        <a href="/book" className="btn btn-outline-light btn-lg px-4">Register</a>
                    </div>
                </div>
            </div>
                <div className="">
